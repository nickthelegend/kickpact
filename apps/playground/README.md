...
> [!NOTE]
> * **English**: Read the complete [Playground Guide](file:///Users/alvin/Developer/sui-flow/kickpact/temp/playground/PLAYGROUND_GUIDE.md) for a detailed walkthrough of all tabs, how to use them, and core concepts.
> * **Tiếng Việt**: Đọc hướng dẫn chi tiết [Ý Nghĩa Các Tính Năng](file:///Users/alvin/Developer/sui-flow/kickpact/temp/playground/PLAYGROUND_FEATURES_GUIDE_VI.md) để hiểu sâu về cơ chế hoạt động on-chain của từng chức năng.
