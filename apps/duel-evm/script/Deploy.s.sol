...
/// @notice Deploy MockUSDT + KickpactDuel to Sepolia (chainId 11155111).
/// @dev    Set DEPLOYER_PRIVATE_KEY and (optionally) ORACLE_ADDRESS in env.
///         forge script script/Deploy.s.sol --rpc-url sepolia --broadcast
contract Deploy is Script {
    function run() external returns (MockUSDT usdt, KickpactDuel duel) {
        ...
        console.log("KickpactDuel deployed at:", address(duel));
